...
from projetocomunidade import app, database, bcrypt
from projetocomunidade.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
from projetocomunidade.models import Usuario, Post
...
def atualizar_cursos(form):
    ...
    for campo in form:
        if 'curso_' in campo.name:
            if campo.data:
                # adiconar o texto do campo.label na lista de cursos
